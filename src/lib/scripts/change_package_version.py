...
def modify_license( path, package, major, minor, patch ):
	...
	f.write("# :ant: "+package+" "+version+"\n")
	f.write("Copyright &copy; 2014-2018 Charles Rocabert, Jérôme Gippet, Serge Fenet.\n")
	f.write("\n")
...
# MODIFY CMAKELISTS.TXT       #
#-----------------------------#
def modify_readme( path, package, major, minor, patch ):
	version = major+"."+minor+"."+patch
...
if __name__ == '__main__':
	...
	modify_readme(PATH, PACKAGE, MAJOR, MINOR, PATCH)
